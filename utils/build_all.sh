...
cmake "-DCMAKE_INSTALL_PREFIX=../install" "-DBOARD_TYPE=stm32f411discovery" "-DCHIP_FAMILY=STM32F4" "-DCMAKE_TOOLCHAIN_FILE=../../libsrc/mouros/cmake/arm-none-eabi-toolchain.cmake" "-DCMAKE_BUILD_TYPE=Debug" "-DINCLUDE_SPINNER=1" "-DINCLUDE_METEO=1" ../..
check_retval
...
cmake "-DCMAKE_INSTALL_PREFIX=../install" "-DBOARD_TYPE=stm32f411discovery" "-DCHIP_FAMILY=STM32F4" "-DCMAKE_TOOLCHAIN_FILE=../../libsrc/mouros/cmake/arm-none-eabi-toolchain.cmake" "-DCMAKE_BUILD_TYPE=Release" "-DINCLUDE_SPINNER=1" "-DINCLUDE_METEO=1" ../..
check_retval
